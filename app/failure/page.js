    ...
    <>
        ...
        <div className="mt-14 p-4 w-auto max-w-sm mx-auto overflow-hidden bg-white border rounded-lg">
            ...
            <div className="mt-5 mx-auto" style={{ width: "5rem" }} >
                    ...
                    <h2 className="text-3xl mt-5 font-bold text-center text-red-600">Failed!</h2>
                <h3 className="mt-4 text-xl font-medium text-center text-gray-600">Your Transaction Was Not Successful</h3>
                <Link href={"/"}>
